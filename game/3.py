...
text = "You walk along the path until you"
text2 = "see a rather sharp stick.  It could"
text3 = "prove to be useful eventually."
text4 = "Do you want to take it or not?"

combtext = '<font size = 20>' + '<p style="text-align: center;">' + text + '<br>' + text2 + '<br>' + text3 + '<br>' + text4

button1 ='<form name="input" action="12.py" method="get"><input type="submit" value="Take it"></form>'
button2 ='<form name="input" action="14.py" method="get"><input type="submit" value="Let it be"></form>'
buttons ='<div style="text-align:center">' + button1 + button2 + '</div>'
