...
text2 = "signs that a bear has marked"
text3 = "its territory.  Luckily the"
text4 = "boar loses attention real fast."
text5 = "to the north, you see bright"
text6 = "light hear noises.  It would be"
