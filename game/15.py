...
text= "WHY WOULD YOU NOT GO THERE?"
text2 = "ARE YOU KIDDING ME?  THERE"
text3 = "IS NO BETTER PLACE.  YOU"
text4 = "KNOW WHAT, GO OFF ON YOUR"
text5 = "OWN, I WILL GUIDE YOU NO LONGER."
text6 = "I do everything for you, you"
text7 = "will not even be able to see."

formatted = '<font size = "20"><p style="text-align: center;">' + text + '<br>' + text2 + '<br>' + text3 + '<br>' + text4 + '<br>' + text5 + '<br>' + text6 + '<br>' + text7

button1 ='<form name="input" action="blank.html" method="get"><input type="submit" value="Wait."></form>'
button2 ='<form name="input" action="blank.html" method="get"><input type="submit" value="What?"></form>'
