...
text = "Your stomach rumbles, and"
text2 = "you hunger for even a small"
text3 = "meal.  Luckily, you see a"
text4 = "delicious looking mushroom"
text5 = "You could ignore it, but it"
text6 = "is so tempting!"

combtext = '<font size = 20>' + '<p style="text-align: center;">' + text + '<br>' + text2 + '<br>' + text3 + '<br>' + text4 + '<br>' + text5 + '<br>' + text6

button1 ='<form name="input" action="Result6.html" method="get"><input type="submit" value="Eat"></form>'
button2 ='<form name="input" action="16.py" method="get"><input type="submit" value="Look the other way"></form>'
