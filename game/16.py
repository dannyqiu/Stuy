...
text = "The sky becomes dark, and"
text2 = "you hear a low rumbling."
text3 = "It starts raining, pouring."
text4 = "Lightning flashs, it isn't"
text5 = "safe to stay outside."
text6 = "The treee near you could provide"
text7 = "adequate protection from the"
text8 = "rain, or you can enter a small"
text9 = "cave a few yards away."

combtext = '<font size = 20>' + '<p style="text-align: center;">' + text + '<br>' + text2 + '<br>' + text3 + '<br>' + text4 + '<br>' + text5 + '<br>' + text6 + '<br>' + text7  + '<br>' + text8 + '<br>' + text9 + '</font>'
button1 ='<form name="input" action="Result7.html" method="get"><input type="submit" value="Tree"></form>'
button2 ='<form name="input" action="Result8.html" method="get"><input type="submit" value="Cave"></form>'
